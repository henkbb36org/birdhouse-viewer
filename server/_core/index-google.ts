...
import { configureGoogleOAuth, isGoogleOAuthConfigured } from "../google-oauth";
import { registerGoogleOAuthRoutes } from "../google-oauth-routes";
import { createContextWithPassport } from "./context-google";
...
async function startServer() {
  ...
  // Notification API (for Python motion handler)
